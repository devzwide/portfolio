...
const projects = [
    {
        ...
        description: "Campus security system to alert campus commmunity on emergencies arising around campus, integrated Firebase services.",
        image:'/campus-security.png',
        technologies: ["Kotlin", "Jetpack Compose", "Mobile Development"],
        liveLink: '#',
    ...
    },
    {
        ...
        subtitle: "Group Project",
        description: "Peer tutoring booking system web app built with Flask, streamlining scheduling and enhancing educational support.",
        image:'/tute-me.png',
